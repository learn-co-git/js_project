...
Comment.create([
  {statement: "I loved this place", user_name: "Neil E", office_id: 1},
  {statement: "It was really noisy when I was there", user_name: "Jane Doe", office_id: 2},
  {statement: "Perfect, absolutely perfect place to work for the day", user_name: "Tom Robbins", office_id: 3}
  ])
